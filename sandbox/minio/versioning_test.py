...
v1_path = "sandbox/minio/profile_v1.txt"
v2_path = "sandbox/minio/profile_v2.txt"
...
service.download_file(object_name, "sandbox/minio/downloaded_latest.txt")
print("Latest version retrieved successfully.")

print("Retrieving Version 1...")
service.download_file(object_name, "sandbox/minio/downloaded_v1.txt", version_id=res_v1.version_id)
